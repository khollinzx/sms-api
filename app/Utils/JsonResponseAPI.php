...
// This can be found in the Symfony\Component\HttpFoundation\Response class
     ...
     * @return JsonResponse
     */
    public static function successResponse(string $message = 'Success', $data = null, int $statusCode = 200, string $action = null): JsonResponse
    {
     ...
     * @return array
     */
    public static function promptForAnAction( string $action, string $message = 'Success'): array
    {
        return [
            'status' => false,
            'message' => $message,
